...
<body class="container"> 
	...
	<form class="form-horizontal" method="POST" action="addChild.php">
	<div id="left">
	...
	if (isset($_POST['submit'])){
		...
		$addChild = "INSERT INTO myChild(id, firstName, lastName, parent_Fname, parent_Lname, date_of_birth, allergies, phone_number, address,city, zip) 
